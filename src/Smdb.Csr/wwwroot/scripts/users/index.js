// Added by Copilot: user list page JS for browsing and deleting users.
// Added by Copilot: keeps the user UI aligned with movie and actor lists.
import {
  $,
  apiFetch,
  renderStatus,
  ...
  try {
    ...
    if (items.length === 0) {
      ...
      for (const u of items) {
        ...
        root.querySelector(".title").textContent = u.fullName ?? "—";
