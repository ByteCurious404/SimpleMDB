...
public class MemoryDatabase
{
    ...
    private void SeedMovies()
    {
        Movies.AddRange(new Movie[]
        {
            ...
            new Movie(29, "The Usual Suspects", 1995, "A survivor’s tale hints at the legend of Keyser Söze."),
            ...
            new Movie(38, "Amélie", 2001, "A shy Parisian secretly improves others’ lives."),
    ...
    private void SeedActors()
    {
        ...
        {
            new Actor(1, "Timothée Chalamet", 1995, "French-American actor known for Dune and Wonka."),
            new Actor(2, "Zendaya", 1996, "Actress known for Dune and Euphoria."),
